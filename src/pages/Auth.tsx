...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md glass-card glow animate-fade-in">
        <CardHeader className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 rounded-2xl bg-primary/20 flex items-center justify-center">
            <Bug className="w-8 h-8 text-primary" />
          </div>
          <div>
            <CardTitle className="text-2xl font-bold gradient-text">BugTracker</CardTitle>
            <CardDescription className="text-muted-foreground mt-2">
              Track bugs, manage projects, ship faster
            </CardDescription>
          </div>
        </CardHeader>
